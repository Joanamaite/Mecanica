...
@section('title', 'Adicionar funcionários')

@section('content')

<div class="imagemFundo4">
    <div class="info">
        <h1 class="tituloAdicionar">Cadastro de mecanicos</h1>
        <form action="{{ route('mecanico.store') }}" method="post">
            ...
            <div class="text-center mt-3">
                <input type="text" class="inputCadastro" placeholder="Especialidade" name="especialidade">
            </div>
            <div class="text-center mt-3">
